...
class GradientEstimator(ABC):
    def __init__(self, cost: _CostFunction, dist_type: DistributionType) -> None:
        self.__cost: Final[_CostFunction] = cost
        self.__dist_type: Final[DistributionType] = dist_type
        self.__dist: Final[_Distribution] = get_distribution_from_type(self.__dist_type)
